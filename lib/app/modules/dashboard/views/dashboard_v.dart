...
import '../../../constanta/variable.dart';
                                ...
                                child: Column(
                                  ...
                                  children: [ 
                                    Text(
                                      ...
                                      style: poppinsTextFont.copyWith(fontSize: 20,fontWeight: FontWeight.w700),
                                    ),
                                    const Gap(10),
                                    Text(
                                      "Speed, Efficiency, Convenience",
                                      style: poppinsTextFont.copyWith(fontSize: 16,color: defaultColor, fontWeight: FontWeight.w700),
                                    ),
                                    const Gap(10),
                                    CustomButton(
                                      text: "Learn $appName", 
